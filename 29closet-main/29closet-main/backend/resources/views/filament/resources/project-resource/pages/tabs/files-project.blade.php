<x-filament-panels::page>
    ...
    <div class="redmine-overview">
        ...
        @include('filament.resources.project-resource.pages.tabs._tabs', ['tabs' => $tabs, 'activeTab' => 'files'])

        <section class="redmine-box">
            <h2 style="font-size: 16px; font-weight: 700; margin-bottom: 8px;">Files</h2>
            <p>Quản lý tệp của nhóm.</p>
        </section>
    </div>
</x-filament-panels::page>
