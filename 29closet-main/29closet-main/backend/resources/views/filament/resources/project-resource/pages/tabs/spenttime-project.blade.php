<x-filament-panels::page>
    ...
    <div class="redmine-overview">
        ...
        @include('filament.resources.project-resource.pages.tabs._tabs', ['tabs' => $tabs, 'activeTab' => 'spent_time'])

        <section class="redmine-box">
            <h2 style="font-size: 16px; font-weight: 700; margin-bottom: 8px;">Spent time</h2>
            <p>Theo dõi thời gian thực hiện công việc.</p>
        </section>
    </div>
</x-filament-panels::page>
