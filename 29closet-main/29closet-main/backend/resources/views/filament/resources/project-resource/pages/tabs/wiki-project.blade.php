<x-filament-panels::page>
    ...
    <div class="redmine-overview">
        ...
        @include('filament.resources.project-resource.pages.tabs._tabs', ['tabs' => $tabs, 'activeTab' => 'wiki'])

        <section class="redmine-box">
            <h2 style="font-size: 16px; font-weight: 700; margin-bottom: 8px;">Wiki</h2>
            <p>Tri thức nội bộ nhóm.</p>
        </section>
    </div>
</x-filament-panels::page>
