<x-filament-panels::page>
    ...
    <div class="redmine-overview">
        ...
        @include('filament.resources.project-resource.pages.tabs._tabs', ['tabs' => $tabs, 'activeTab' => 'gantt'])

        <section class="redmine-box">
            <h2 style="font-size: 16px; font-weight: 700; margin-bottom: 8px;">Gantt</h2>
            <p>Theo dõi công việc dạng timeline.</p>
        </section>
    </div>
</x-filament-panels::page>
